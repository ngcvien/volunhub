            ...
            <header id="header" className="header d-flex align-items-center fixed-top">
                ...
                >
                    ...
                    <nav id="navmenu" className="navmenu">
                        <ul>
                            <li>
                                <a href="#home" className="active">Trang chủ<br /></a>
                            </li>
                            <li><a href="#event">Sự kiện</a></li>
                            <li><a href="#testimonials">Cảm nhận</a></li>
            ...
            <main className="main">
                        ...
                        <div className="row gy-4">
                            ...
                            >
                                ...
                                >
                                    ...
                                    ><i className="bi bi-play-circle"></i><span>Xem Video</span></a
                                    >
                                </div>
                            </div>
                            <div
                        ...
                        <div className="row gx-0">
                            ...
                            >
                                <div className="content">
                                    ...
                                    <p>
                                        Chúng tôi tạo ra không gian để mọi người có thể tổ chức sự
                                        kiện thiện nguyện, tham gia hoạt động ý nghĩa và lan tỏa yêu
                                        thương đến những hoàn cảnh khó khăn.
                                    </p>
                ...
                <section id="values" className="values section">
                    ...
                    <div className="container section-title" data-aos="fade-up">
                        <h2>Giá trị</h2>
                        <p>GIÁ TRỊ CỐT LÕI CỦA CHÚNG TÔI<br /></p>
                    </div>
                    {/* End Section Title */}
                        ...
                        <div className="row gy-4">
                            <div className="col-lg-4" data-aos="fade-up" data-aos-delay="100">
                                <div className="card">
                                    ...
                                    <p>
                                        Chúng tôi tin rằng mỗi hành động nhỏ đều có thể tạo nên sự khác biệt. Khi bạn giúp đỡ người khác, bạn cũng đang làm cho thế giới tốt đẹp hơn.
                                    </p>
                                </div>
                            </div>
                            {/* End Card Item */}
                            ...
                            <div className="col-lg-4" data-aos="fade-up" data-aos-delay="200">
                                <div className="card">
                                    ...
                                    <p>
                                        Không chỉ là nơi để tham gia thiện nguyện, đây còn là cộng đồng nơi bạn có thể kết bạn, học hỏi và cùng nhau lan tỏa yêu thương.
                                    </p>
                                </div>
                            </div>
                            {/* End Card Item */}
                            ...
                            <div className="col-lg-4" data-aos="fade-up" data-aos-delay="300">
                                <div className="card">
                                    ...
                                    <p>
                                        Mọi đóng góp đều đáng trân trọng. Chúng tôi có hệ thống tích điểm và vinh danh những tình nguyện viên có nhiều đóng góp nhất.
                                    </p>
                                </div>
                            </div>
                            {/* End Card Item */}
                                ...
                                <div className="row align-self-center gy-5">
                                    <div className="col-md-6 icon-box">
                                        ...
                                        <div>
                                            ...
                                            <p>
                                                Gặp gỡ, giao lưu và kết nối với hàng nghìn tình nguyện viên trên toàn quốc.
                                            </p>
                                        </div>
                                    </div>
                                    {/* End Feature Item */}
                                    ...
                                    <div className="col-md-6 icon-box">
                                        ...
                                        <div>
                                            ...
                                            <p>
                                                Tạo sự kiện nhanh chóng, theo dõi tiến độ và mời bạn bè tham gia.
                                            </p>
                                        </div>
                                    </div>
                                    {/* End Feature Item */}
                                    ...
                                    <div className="col-md-6 icon-box">
                                        ...
                                        <div>
                                            ...
                                            <p>
                                                Mỗi đóng góp của bạn đều được ghi nhận thông qua hệ thống tích điểm & huy hiệu.
                                            </p>
                                        </div>
                                    </div>
                                    {/* End Feature Item */}
                                    ...
                                    <div className="col-md-6 icon-box">
                                        ...
                                        <div>
                                            ...
                                            <p>
                                                Tương tác, thảo luận với bạn bè, hoặc tham gia nhóm để tổ chức hoạt động dài hạn.
                                            </p>
                                        </div>
                                    </div>
                                    {/* End Feature Item */}
                                    ...
                                    <div className="col-md-6 icon-box">
                                        ...
                                        <div>
                                            ...
                                            <p>
                                                Luôn cập nhật những sự kiện phù hợp nhất với bạn để không bỏ lỡ cơ hội tham gia.
                                            </p>
                                        </div>
                                    </div>
                                    {/* End Feature Item */}
                                    ...
                                    <div className="col-md-6 icon-box">
                                        ...
                                        <div>
                                            ...
                                            <p>
                                                Ghi lại và hiển thị những hoạt động thiện nguyện bạn đã tham gia, giúp ích cho sự nghiệp & cuộc sống.
                                            </p>
                                        </div>
                                    </div>
                                    {/* End Feature Item */}
                ...
                <section id="pricing" className="pricing section">
                    ...
                    <div className="container">
                        <div className="row gy-4">
                            ...
                            >
                                <div className="pricing-tem">
                                    <h3 style={{ color: "#0d6efd" }}>Business Plan</h3>
                                    <div className="price"><sup>$</sup>29<span> / mo</span></div>
                                    <div className="icon">
                                        <i className="bi bi-airplane" style={{ color: "#0d6efd" }}></i>
                                    </div>
                                    <ul>
                                        <li>Aida dere</li>
                                        <li>Nec feugiat nisl</li>
                        ...
                        <div className="row">
                                ...
                                <div className="faq-container">
                                    <div className="faq-item faq-active">
                                        ...
                                        <div className="faq-content">
                                            <p>
                                                Bạn có thể duyệt qua danh sách các hoạt động và bấm "Quan tâm"
                                                hoặc "Tôi sẽ tham gia". Người tổ chức sẽ liên hệ nếu cần thêm thông tin.
                                            </p>
                                        </div>
                                    ...
                                    <div className="faq-item">
                                        <h3>
                                            Tôi có thể tự tạo một hoạt động không?
                                        </h3>
                                        <div className="faq-content">
                                            <p>
                                                Có! Sau khi đăng ký tài khoản, bạn có thể tạo hoạt động mới, mô tả chi tiết và
                                                kêu gọi tình nguyện viên tham gia.
                                            </p>
                                        </div>
                                        <i className="faq-toggle bi bi-chevron-right"></i>
                                    </div>
                                    ...
                                    <div className="faq-item">
                                        <h3>
                                            Làm thế nào để tích lũy điểm tình nguyện?
                                        </h3>
                                        <div className="faq-content">
                                            <p>
                                                Sau khi tham gia một hoạt động và hoàn thành, hệ thống sẽ ghi nhận số điểm
                                                tương ứng. Điểm này có thể dùng để xếp hạng hoặc nhận phần thưởng từ các đối tác.
                                            </p>
                                        </div>
                                        <i className="faq-toggle bi bi-chevron-right"></i>
                                    </div>
                            ...
                            <div className="col-lg-6" data-aos="fade-up" data-aos-delay="200">
                                <div className="faq-container">
                                    <div className="faq-item">
                                        <h3>
                                            Làm sao để liên hệ với người tổ chức?
                                        </h3>
                                        <div className="faq-content">
                                            <p>
                                                Bạn có thể nhắn tin trực tiếp thông qua hệ thống hoặc tham gia nhóm liên quan đến hoạt động đó.
                                            </p>
                                        </div>
                                        <i className="faq-toggle bi bi-chevron-right"></i>
                                    </div>
                                    ...
                                    <div className="faq-item">
                                        <h3>
                                            Có thể tìm kiếm các hoạt động theo địa điểm hoặc lĩnh vực không?
                                        </h3>
                                        <div className="faq-content">
                                            <p>
                                                Có thể! Bạn có thể lọc hoạt động theo tỉnh/thành phố, thời gian
                                                hoặc loại hình thiện nguyện như cứu trợ, giáo dục, môi trường...
                                            </p>
                                        </div>
                                        <i className="faq-toggle bi bi-chevron-right"></i>
                                    </div>
                                    ...
                                    <div className="faq-item">
                                        ...
                                        <div className="faq-content">
                                            <p>
                                                Có, các tổ chức phi lợi nhuận có thể đăng ký và tạo hoạt động để
                                                tìm kiếm tình nguyện viên phù hợp.
                                            </p>
                                        </div>
                                        <i className="faq-toggle bi bi-chevron-right"></i>
                                    </div>
                            ...
                            >
                                ...
                                >
                                    <div className="portfolio-content h-100">
                                        ...
                                        <div className="portfolio-info">
                                            <h4>Cần thơ</h4>
                                            <p>ra mắt 09 tuyến đường “Văn minh – an toàn – xanh – sạch – đẹp”</p>
                                            <a
                                ...
                                >
                                    <div className="portfolio-content h-100">
                                        ...
                                        <div className="portfolio-info">
                                            ...
                                            <p>mở các lớp học cho các trẻ em nghèo cũng như giúp đỡ các em nhỏ bị chậm phát triển hay tự kỉ</p>
                                            <a
                                ...
                                >
                                    <div className="portfolio-content h-100">
                                        ...
                                        <div className="portfolio-info">
                                            ...
                                            <p>Trưởng ban Từ thiện trao quà và học bổng cho học sinh có hoàn cảnh khó khăn huyện Khánh Vĩnh.</p>
                                            <a
                                ...
                                >
                                    <div className="portfolio-content h-100">
                                        ...
                                        <div className="portfolio-info">
                                            ...
                                            <p>một lớp học dành cho những đứa trẻ “đặc biệt” hoàn toàn miễn phí</p>
                                            <a
                                ...
                                >
                                    <div className="portfolio-content h-100">
                                        ...
                                        <div className="portfolio-info">
                                            <h4>Sài gòn xanh</h4>
                                            <p>
                                                không chỉ là một tổ chức, mà còn là sứ mệnh của tất cả chúng ta
                                            </p>
                                            <a
                                ...
                                >
                                    <div className="portfolio-content h-100">
                                        ...
                                        <div className="portfolio-info">
                                            ...
                                            <p>Trải qua gần 13 năm hoạt động, đến nay, với sự hỗ trợ của chính quyền địa phương,
                                                Đoàn thanh niên, những nhà hảo tâm và sinh viên tình nguyện, lớp học đã tiến thêm một bước mới là “phổ cập tình thương”</p>
                                            <a
                                ...
                                >
                                    <div className="portfolio-content h-100">
                                        ...
                                        <div className="portfolio-info">
                                            ...
                                            <p>Tình nguyện viên nhiều nơi tiến về vùng lũ hỗ trợ công tác sau lũ</p>
                                            <a
                ...
                <section id="testimonials" className="testimonials section">
                    ...
                    <div className="container section-title" data-aos="fade-up">
                        <h2>Nhận xét</h2>
                        <p>Những gì họ nói về chúng tôi<br /></p>
                    </div>
                    {/* End Section Title */}
                            ...
                            <div className="swiper-wrapper">
                                <div className="swiper-slide">
                                    <div className="testimonial-item">
                                        ...
                                        <p>
                                            VolunHub thực sự là một nền tảng tuyệt vời! Nhờ có nó, tôi đã kết nối với rất nhiều người có chung chí hướng và cùng nhau giúp đỡ cộng đồng.
                                        </p>
                                ...
                                <div className="swiper-slide">
                                    <div className="testimonial-item">
                                        ...
                                        <p>
                                            Giao diện dễ sử dụng, thông tin rõ ràng và hỗ trợ rất nhanh chóng. Tôi đã tìm thấy nhiều cơ hội tình nguyện phù hợp nhờ VolunHub.
                                        </p>
                                        <div className="profile mt-auto">
                                            <img
                                ...
                                <div className="swiper-slide">
                                    <div className="testimonial-item">
                                        ...
                                        <p>
                                            Nhờ VolunHub, tôi đã có cơ hội giúp đỡ những người cao tuổi neo đơn trong khu vực. Đây thực sự là một sáng kiến có ý nghĩa lớn.
                                        </p>
                                        <div className="profile mt-auto">
                                            <img
                                ...
                                <div className="swiper-slide">
                                    <div className="testimonial-item">
                                        ...
                                        <p>
                                            Tôi thực sự ấn tượng với cách VolunHub sử dụng công nghệ để kết nối mọi người. Mọi thứ trở nên thuận tiện hơn rất nhiều!
                                        </p>
                                        <div className="profile mt-auto">
                                            <img
                                ...
                                <div className="swiper-slide">
                                    <div className="testimonial-item">
                                        ...
                                        <p>
                                            Tôi chưa bao giờ nghĩ rằng việc tham gia tình nguyện lại dễ dàng đến thế. VolunHub thực sự đã thay đổi cách tôi tiếp cận việc giúp đỡ cộng đồng.
                                        </p>
                                        <div className="profile mt-auto">
                                            <img
                            ...
                            <div className="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
                                <div className="team-member">
                                    ...
                                    <div className="member-info">
                                        ...
                                        <p>
                                            Là người đặt nền móng cho VolunHub, Viên luôn
                                            tâm huyết với việc kết nối tình nguyện viên và
                                            các tổ chức từ thiện để giúp cuộc sống tốt đẹp hơn.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="300">
                                <div className="team-member">
                                    ...
                                    <div className="member-info">
                                        ...
                                        <span>CTO</span>
                                        <p>
                                            Chịu trách nhiệm về phát triển công nghệ cho
                                            VolunHub, Duy luôn mang đến những giải pháp kỹ
                                            thuật hiệu quả giúp nâng cao trải nghiệm người dùng.
                                        </p>
                                    </div>
                                </div>
                            </div>

                            <div className="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="400">
                                <div className="team-member">
                                    <div className="member-img">
                                    ...
                                    <div className="member-info">
                                        ...
                                        <p>
                                            Tân phụ trách việc truyền thông và quảng bá cho VolunHub, đảm bảo thông điệp của chúng tôi
                                            lan tỏa ra rộng rãi đến cộng đồng.
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="row gy-5">
                            <div className="col-xl-4 col-md-6">
                                <div className="post-item position-relative h-100" data-aos="fade-up" data-aos-delay="100">
                                    <div className="post-img position-relative overflow-hidden">
                                        <img src="https://phunuvietnam.mediacdn.vn/179072216278405120/2021/12/31/yola-1-16409497614121089453110.jpg" className="img-fluid" alt="" />
                                        <span className="post-date">12 Tháng 12</span>
                                    </div>

                                    <div className="post-content d-flex flex-column">
                                        <h3 className="post-title">Chuyến thiện nguyện đến vùng cao – Trao yêu thương</h3>
                                        ...
                                        <hr />
                                        <a href="" className="readmore stretched-link"><span>Đọc thêm</span><i className="bi bi-arrow-right"></i></a>
                                    </div>
                                </div>
                            </div>
                            {/* End post item */}
                            ...
                            <div className="col-xl-4 col-md-6">
                                <div className="post-item position-relative h-100" data-aos="fade-up" data-aos-delay="200">
                                    <div className="post-img position-relative overflow-hidden">
                                        <img src="https://cdn.thuvienphapluat.vn//uploads/tintuc/2023/03/23/hien-mau-nhan-dao.jpeg" className="img-fluid" alt="" />
                                        <span className="post-date">17 Tháng 7</span>
                                    </div>

                                    <div className="post-content d-flex flex-column">
                                        <h3 className="post-title">Kêu gọi hiến máu cứu người – Hành động nhỏ, ý nghĩa lớn</h3>
                                        <div className="meta d-flex align-items-center">
                                            <div className="d-flex align-items-center">
                                                <i className="bi bi-person"></i>
                            ...
                            <div className="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
                                <div className="post-item position-relative h-100">
                                    <div className="post-img position-relative overflow-hidden">
                                        <img src="https://intracom.com.vn/wp-content/uploads/2024/05/nguoi-gia-neo-don-la-gi-2.jpg.webp" className="img-fluid" alt="" />
                                        <span className="post-date">05 Tháng 9</span>
                                    </div>

                                    <div className="post-content d-flex flex-column">
                                        <h3 className="post-title">Chương trình hỗ trợ người già neo đơn tại TP.HCM</h3>
                                        <div className="meta d-flex align-items-center">
                                            <div className="d-flex align-items-center">
                                                <i className="bi bi-person"></i>
                ...
                <section id="clients" className="clients section">
                    ...
                    <div className="container section-title" data-aos="fade-up">
                        ...
                        <p>Hợp tác cùng các tổ chức từ thiện để tạo ra tác động tích cực<br /></p>
                    </div>
                    {/* End Section Title */}
                    ...
                    <div className="container">
                        <div className="row justify-content-center text-center">
                            <div className="col-lg-6">
                                <h4>Đăng Ký</h4>
                                <p>
                                    Đăng ký ngay để gia nhập cùng chúng tôi!
                                </p>
                                <form action="forms/register.php" method="post" className="php-email-form">
                                    ...
                                    <div className="loading">Đang gửi...</div>
                                    <div className="error-message"></div>
                                    <div className="sent-message">Bạn đã đăng ký thành công. Cảm ơn bạn!</div>
                                </form>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="row gy-4">
                        <div className="col-lg-4 col-md-6 footer-about">
                            ...
                            <div className="footer-contact pt-3">
                                <p>470 Trần Đại Nghĩa</p>
                                <p>Đà Nẵng, Việt Nam</p>
                                <p className="mt-3"><strong>Hotline:</strong> <span>0905100200</span></p>
                                <p><strong>Email:</strong> <span>volunhub.contact@net.vn</span></p>
                            </div>
                        </div>
                        ...
                        <div className="col-lg-2 col-md-3 footer-links">
                            ...
                            <ul>
                                ...
                                <li><i className="bi bi-chevron-right"></i> <a href="#">Về chúng tôi</a></li>
                                <li><i className="bi bi-chevron-right"></i> <a href="#">Dịch vụ</a></li>
                                <li><i className="bi bi-chevron-right"></i> <a href="#">Điều khoản</a></li>
                            </ul>
                        </div>
                        ...
                        <div className="col-lg-2 col-md-3 footer-links">
                            ...
                            <ul>
                                <li><i className="bi bi-chevron-right"></i> <a href="#">Kết nối thiện nguyện</a></li>
                                <li><i className="bi bi-chevron-right"></i> <a href="#">Hỗ trợ người già</a></li>
                                <li><i className="bi bi-chevron-right"></i> <a href="#">Gây quỹ từ thiện</a></li>
                                <li><i className="bi bi-chevron-right"></i> <a href="#">Hỗ trợ cộng đồng</a></li>
                            </ul>
                        </div>

                        <div className="col-lg-4 col-md-12">
                            <h4>Theo Dõi Chúng Tôi</h4>
                            <p>Kết nối với chúng tôi trên mạng xã hội để không bỏ lỡ bất kỳ hoạt động nào.</p>
